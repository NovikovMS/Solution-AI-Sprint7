...
| Появление сегмента, которого не было в обучении, например селлеров маркетплейсов | Вход | Заметная доля потока | Не писать оценку по этому сегменту, пока по нему не размечена контрольная выборка | Владелец сервиса |
